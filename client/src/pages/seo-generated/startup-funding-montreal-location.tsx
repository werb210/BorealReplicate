...
export default function StartupFundingMontrealLocationPage() {
  const faqs = getLocationFaqs("Startup Business Funding", "Montreal");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find startup business funding in Montreal with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/startup-funding/montreal"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding in Montreal | Boreal Financial"
        description="Find startup business funding in Montreal with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/startup-funding/montreal"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding in Montreal</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Montreal compare startup business funding offers with transparent guidance and practical timelines.</p>
