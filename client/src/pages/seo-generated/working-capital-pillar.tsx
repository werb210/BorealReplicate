...
export default function WorkingCapitalPillarPage() {
  const faqs = getProductFaqs("Working Capital Loans");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Explore working capital loans options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses.",
    url: BASE_URL + "/products/working-capital"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans | Boreal Financial"
        description="Explore working capital loans options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses."
        canonical={BASE_URL + "/products/working-capital"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans in Canada</h1>
      <p className="text-lg text-slate-700 mb-6">Discover how working capital loans can support growth, cover operational gaps, and improve cash-flow flexibility for your business.</p>
