...
export default function EquipmentFinancingManufacturingIndustryPage() {
  const faqs = getIndustryFaqs("Equipment Financing", "manufacturing");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Learn how equipment financing supports manufacturing businesses with financing structures designed for operational realities and growth goals.",
    url: BASE_URL + "/products/equipment-financing/industry/manufacturing"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing for Manufacturing | Boreal Financial"
        description="Learn how equipment financing supports manufacturing businesses with financing structures designed for operational realities and growth goals."
        canonical={BASE_URL + "/products/equipment-financing/industry/manufacturing"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing for Manufacturing Businesses</h1>
      <p className="text-lg text-slate-700 mb-6">Compare equipment financing programs built for manufacturing operators seeking predictable repayment and working-capital resilience.</p>
