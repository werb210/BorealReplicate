...
export default function WorkingCapitalCalgaryLocationPage() {
  const faqs = getLocationFaqs("Working Capital Loans", "Calgary");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find working capital loans in Calgary with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/working-capital/calgary"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans in Calgary | Boreal Financial"
        description="Find working capital loans in Calgary with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/working-capital/calgary"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans in Calgary</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Calgary compare working capital loans offers with transparent guidance and practical timelines.</p>
