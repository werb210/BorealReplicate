...
export default function StartupFundingPoorCreditFriendlyIntentPage() {
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Review startup business funding options for businesses prioritizing poor credit friendly, with clear expectations for qualification and funding timelines.",
    url: BASE_URL + "/products/startup-funding/intent/poor-credit-friendly"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding - Poor Credit Friendly | Boreal Financial"
        description="Review startup business funding options for businesses prioritizing poor credit friendly, with clear expectations for qualification and funding timelines."
        canonical={BASE_URL + "/products/startup-funding/intent/poor-credit-friendly"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding with Poor Credit Friendly</h1>
      <p className="text-lg text-slate-700 mb-6">If your priority is poor credit friendly, this page outlines how startup business funding solutions can be structured to meet your financing goals.</p>
