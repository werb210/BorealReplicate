...
export default function WorkingCapitalTorontoLocationPage() {
  const faqs = getLocationFaqs("Working Capital Loans", "Toronto");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find working capital loans in Toronto with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/working-capital/toronto"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans in Toronto | Boreal Financial"
        description="Find working capital loans in Toronto with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/working-capital/toronto"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans in Toronto</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Toronto compare working capital loans offers with transparent guidance and practical timelines.</p>
