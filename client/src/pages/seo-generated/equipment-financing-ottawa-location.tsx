...
export default function EquipmentFinancingOttawaLocationPage() {
  const faqs = getLocationFaqs("Equipment Financing", "Ottawa");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find equipment financing in Ottawa with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/equipment-financing/ottawa"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing in Ottawa | Boreal Financial"
        description="Find equipment financing in Ottawa with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/equipment-financing/ottawa"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing in Ottawa</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Ottawa compare equipment financing offers with transparent guidance and practical timelines.</p>
