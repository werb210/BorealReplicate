...
export default function WorkingCapitalConstructionIndustryPage() {
  const faqs = getIndustryFaqs("Working Capital Loans", "construction");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Learn how working capital loans supports construction businesses with financing structures designed for operational realities and growth goals.",
    url: BASE_URL + "/products/working-capital/industry/construction"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans for Construction | Boreal Financial"
        description="Learn how working capital loans supports construction businesses with financing structures designed for operational realities and growth goals."
        canonical={BASE_URL + "/products/working-capital/industry/construction"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans for Construction Businesses</h1>
      <p className="text-lg text-slate-700 mb-6">Compare working capital loans programs built for construction operators seeking predictable repayment and working-capital resilience.</p>
