...
export default function StartupFundingManufacturingIndustryPage() {
  const faqs = getIndustryFaqs("Startup Business Funding", "manufacturing");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Learn how startup business funding supports manufacturing businesses with financing structures designed for operational realities and growth goals.",
    url: BASE_URL + "/products/startup-funding/industry/manufacturing"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding for Manufacturing | Boreal Financial"
        description="Learn how startup business funding supports manufacturing businesses with financing structures designed for operational realities and growth goals."
        canonical={BASE_URL + "/products/startup-funding/industry/manufacturing"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding for Manufacturing Businesses</h1>
      <p className="text-lg text-slate-700 mb-6">Compare startup business funding programs built for manufacturing operators seeking predictable repayment and working-capital resilience.</p>
