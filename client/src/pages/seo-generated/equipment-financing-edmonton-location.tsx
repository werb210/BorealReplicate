...
export default function EquipmentFinancingEdmontonLocationPage() {
  const faqs = getLocationFaqs("Equipment Financing", "Edmonton");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find equipment financing in Edmonton with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/equipment-financing/edmonton"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing in Edmonton | Boreal Financial"
        description="Find equipment financing in Edmonton with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/equipment-financing/edmonton"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing in Edmonton</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Edmonton compare equipment financing offers with transparent guidance and practical timelines.</p>
