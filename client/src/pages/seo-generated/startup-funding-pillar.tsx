...
export default function StartupFundingPillarPage() {
  const faqs = getProductFaqs("Startup Business Funding");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Explore startup business funding options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses.",
    url: BASE_URL + "/products/startup-funding"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding | Boreal Financial"
        description="Explore startup business funding options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses."
        canonical={BASE_URL + "/products/startup-funding"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding in Canada</h1>
      <p className="text-lg text-slate-700 mb-6">Discover how startup business funding can support growth, cover operational gaps, and improve cash-flow flexibility for your business.</p>
