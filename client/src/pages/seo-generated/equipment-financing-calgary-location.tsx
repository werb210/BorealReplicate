...
export default function EquipmentFinancingCalgaryLocationPage() {
  const faqs = getLocationFaqs("Equipment Financing", "Calgary");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find equipment financing in Calgary with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/equipment-financing/calgary"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing in Calgary | Boreal Financial"
        description="Find equipment financing in Calgary with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/equipment-financing/calgary"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing in Calgary</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Calgary compare equipment financing offers with transparent guidance and practical timelines.</p>
