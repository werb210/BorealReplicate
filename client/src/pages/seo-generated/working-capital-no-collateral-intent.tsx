...
export default function WorkingCapitalNoCollateralIntentPage() {
  const faqs = getIntentFaqs("Working Capital Loans", "no collateral");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Review working capital loans options for businesses prioritizing no collateral, with clear expectations for qualification and funding timelines.",
    url: BASE_URL + "/products/working-capital/intent/no-collateral"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans - No Collateral | Boreal Financial"
        description="Review working capital loans options for businesses prioritizing no collateral, with clear expectations for qualification and funding timelines."
        canonical={BASE_URL + "/products/working-capital/intent/no-collateral"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans with No Collateral</h1>
      <p className="text-lg text-slate-700 mb-6">If your priority is no collateral, this page outlines how working capital loans solutions can be structured to meet your financing goals.</p>
