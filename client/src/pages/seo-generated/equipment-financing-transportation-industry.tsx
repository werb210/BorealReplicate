...
export default function EquipmentFinancingTransportationIndustryPage() {
  const faqs = getIndustryFaqs("Equipment Financing", "transportation");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Learn how equipment financing supports transportation businesses with financing structures designed for operational realities and growth goals.",
    url: BASE_URL + "/products/equipment-financing/industry/transportation"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing for Transportation | Boreal Financial"
        description="Learn how equipment financing supports transportation businesses with financing structures designed for operational realities and growth goals."
        canonical={BASE_URL + "/products/equipment-financing/industry/transportation"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing for Transportation Businesses</h1>
      <p className="text-lg text-slate-700 mb-6">Compare equipment financing programs built for transportation operators seeking predictable repayment and working-capital resilience.</p>
