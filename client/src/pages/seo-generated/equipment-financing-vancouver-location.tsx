...
export default function EquipmentFinancingVancouverLocationPage() {
  const faqs = getLocationFaqs("Equipment Financing", "Vancouver");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find equipment financing in Vancouver with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/equipment-financing/vancouver"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing in Vancouver | Boreal Financial"
        description="Find equipment financing in Vancouver with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/equipment-financing/vancouver"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing in Vancouver</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Vancouver compare equipment financing offers with transparent guidance and practical timelines.</p>
