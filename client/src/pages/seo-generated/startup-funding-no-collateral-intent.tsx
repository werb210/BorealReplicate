...
export default function StartupFundingNoCollateralIntentPage() {
  const faqs = getIntentFaqs("Startup Business Funding", "no collateral");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Review startup business funding options for businesses prioritizing no collateral, with clear expectations for qualification and funding timelines.",
    url: BASE_URL + "/products/startup-funding/intent/no-collateral"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding - No Collateral | Boreal Financial"
        description="Review startup business funding options for businesses prioritizing no collateral, with clear expectations for qualification and funding timelines."
        canonical={BASE_URL + "/products/startup-funding/intent/no-collateral"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding with No Collateral</h1>
      <p className="text-lg text-slate-700 mb-6">If your priority is no collateral, this page outlines how startup business funding solutions can be structured to meet your financing goals.</p>
