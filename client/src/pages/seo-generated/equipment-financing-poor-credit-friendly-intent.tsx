...
export default function EquipmentFinancingPoorCreditFriendlyIntentPage() {
  const faqs = getIntentFaqs("Equipment Financing", "poor credit friendly");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Review equipment financing options for businesses prioritizing poor credit friendly, with clear expectations for qualification and funding timelines.",
    url: BASE_URL + "/products/equipment-financing/intent/poor-credit-friendly"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing - Poor Credit Friendly | Boreal Financial"
        description="Review equipment financing options for businesses prioritizing poor credit friendly, with clear expectations for qualification and funding timelines."
        canonical={BASE_URL + "/products/equipment-financing/intent/poor-credit-friendly"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing with Poor Credit Friendly</h1>
      <p className="text-lg text-slate-700 mb-6">If your priority is poor credit friendly, this page outlines how equipment financing solutions can be structured to meet your financing goals.</p>
