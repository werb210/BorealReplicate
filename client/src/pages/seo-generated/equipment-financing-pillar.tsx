...
export default function EquipmentFinancingPillarPage() {
  const faqs = getProductFaqs("Equipment Financing");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Explore equipment financing options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses.",
    url: BASE_URL + "/products/equipment-financing"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Equipment Financing | Boreal Financial"
        description="Explore equipment financing options with Boreal Financial, including approval factors, timelines, and funding structures for Canadian businesses."
        canonical={BASE_URL + "/products/equipment-financing"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Equipment Financing in Canada</h1>
      <p className="text-lg text-slate-700 mb-6">Discover how equipment financing can support growth, cover operational gaps, and improve cash-flow flexibility for your business.</p>
