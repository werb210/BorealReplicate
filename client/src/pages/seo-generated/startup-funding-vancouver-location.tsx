...
export default function StartupFundingVancouverLocationPage() {
  const faqs = getLocationFaqs("Startup Business Funding", "Vancouver");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Find startup business funding in Vancouver with lender options aligned to local business needs, eligibility, and repayment preferences.",
    url: BASE_URL + "/products/startup-funding/vancouver"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Startup Business Funding in Vancouver | Boreal Financial"
        description="Find startup business funding in Vancouver with lender options aligned to local business needs, eligibility, and repayment preferences."
        canonical={BASE_URL + "/products/startup-funding/vancouver"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Startup Business Funding in Vancouver</h1>
      <p className="text-lg text-slate-700 mb-6">Boreal Financial helps businesses in Vancouver compare startup business funding offers with transparent guidance and practical timelines.</p>
