...
export default function WorkingCapitalFastApprovalIntentPage() {
  const faqs = getIntentFaqs("Working Capital Loans", "fast approval");
  ...
  const financialServiceJsonLd = {
    ...
    areaServed: "Canada",
    description: "Review working capital loans options for businesses prioritizing fast approval, with clear expectations for qualification and funding timelines.",
    url: BASE_URL + "/products/working-capital/intent/fast-approval"
  };

  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <Seo
        title="Working Capital Loans - Fast Approval | Boreal Financial"
        description="Review working capital loans options for businesses prioritizing fast approval, with clear expectations for qualification and funding timelines."
        canonical={BASE_URL + "/products/working-capital/intent/fast-approval"}
        jsonLd={[organizationJsonLd, financialServiceJsonLd]}
      />

      <h1 className="text-4xl font-bold text-primary mb-4">Working Capital Loans with Fast Approval</h1>
      <p className="text-lg text-slate-700 mb-6">If your priority is fast approval, this page outlines how working capital loans solutions can be structured to meet your financing goals.</p>
