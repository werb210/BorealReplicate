...
export const industries: Industry[] = [
  ...
  },
  {
    ...
    description: "Working-capital and order-fulfillment structures for wholesale and distribution operators.",
    summary: "Facilities aligned to inventory turns, supplier terms, and delivery-cycle receivables.",
    heroImage: "https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=1800&q=80",
    advisory:
      "Distribution teams balance inventory commitments, supplier terms, and delayed collections from downstream buyers. Boreal structures facilities that support fulfillment velocity without liquidity strain.",
    challenges: [
      "Inventory purchases must be made before sell-through and customer payments are collected.",
      "Supplier prepayment and freight costs can compress short-term liquidity.",
      "Large customer orders often require fulfillment spending ahead of cash inflows.",
      "Seasonal swings can create uneven working-capital pressure across the year.",
    ],
  },
];
